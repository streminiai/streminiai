...
final floatingScannerProvider = StateNotifierProvider<FloatingScannerNotifier, FloatingScannerState>(
  (ref) => FloatingScannerNotifier(ref),
);
...
class FloatingScannerNotifier extends StateNotifier<FloatingScannerState> {
  final Ref ref;
  static const MethodChannel _channel = MethodChannel('stremini.chat.overlay');

  FloatingScannerNotifier(this.ref) : super(FloatingScannerState());
